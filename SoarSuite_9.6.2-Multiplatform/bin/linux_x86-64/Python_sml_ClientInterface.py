...
def ElementXML_IsValidID(str):
    r"""
    ElementXML_IsValidID(char const * str) -> bool
...
def ElementXML_AllocateString(length):
    r"""
    ElementXML_AllocateString(int length) -> char *
...
def ElementXML_DeleteString(pString):
    r"""
    ElementXML_DeleteString(char * pString)
...
def ElementXML_CopyString(original):
    r"""
    ElementXML_CopyString(char const * original) -> char *
...
def ElementXML_CopyBuffer(original, length):
    r"""
    ElementXML_CopyBuffer(char const * original, int length) -> char *
...
def ElementXML_ParseXMLFromString(pString):
    r"""
    ElementXML_ParseXMLFromString(char const * pString) -> ElementXML
...
def ElementXML_ParseXMLFromStringSequence(pString, startPos, endPos):
    r"""
    ElementXML_ParseXMLFromStringSequence(char const * pString, size_t startPos, size_t * endPos) -> ElementXML
...
def ElementXML_ParseXMLFromFile(pFilename):
    r"""
    ElementXML_ParseXMLFromFile(char const * pFilename) -> ElementXML
...
def ElementXML_GetLastParseErrorDescription():
    r"""ElementXML_GetLastParseErrorDescription() -> char const *"""
    return _Python_sml_ClientInterface.ElementXML_GetLastParseErrorDescription()
...
def AnalyzeXML_DeleteString(pString):
    r"""
    AnalyzeXML_DeleteString(char * pString)
...
def Kernel_CreateKernelInCurrentThread(*args):
    r"""
    Kernel_CreateKernelInCurrentThread(bool optimized=False, int portToListenOn=kDefaultSMLPort) -> Kernel
...
def Kernel_CreateKernelInNewThread(*args):
    r"""
    Kernel_CreateKernelInNewThread(int portToListenOn=kDefaultSMLPort) -> Kernel
...
def Kernel_CreateRemoteConnection(*args):
    r"""
    Kernel_CreateRemoteConnection(bool sharedFileSystem=True, char const * pIPaddress=None, int port=kDefaultSMLPort, bool ignoreOutput=False) -> Kernel
...
def ClientXML_AllocateString(length):
    r"""
    ClientXML_AllocateString(int length) -> char *
...
def ClientXML_DeleteString(pString):
    r"""
    ClientXML_DeleteString(char * pString)
...
def ClientXML_CopyString(original):
    r"""
    ClientXML_CopyString(char const * original) -> char *
...
def ClientXML_CopyBuffer(original, length):
    r"""
    ClientXML_CopyBuffer(char const * original, int length) -> char *
...
def ClientAnalyzedXML_DeleteString(pString):
    r"""
    ClientAnalyzedXML_DeleteString(char * pString)
...
def Soar_Instance_Get_Soar_Instance():
    r"""Soar_Instance_Get_Soar_Instance() -> Soar_Instance"""
    return _Python_sml_ClientInterface.Soar_Instance_Get_Soar_Instance()
